// https://github.com/bonybrown/tiny-AES128-C/blob/master/pkcs7_padding.h

#ifndef UTILITY_ENCRYPTION_PKCS7_PADDING_H
#define UTILITY_ENCRYPTION_PKCS7_PADDING_H
...
#endif // UTILITY_ENCRYPTION_PKCS7_PADDING_H