// Credit: https://github.com/robertdavidgraham/whats-dec/blob/master/crypto-sha256-hmac.c
...
SECTION_CODE void hmac_sha256_init(HMAC_CTX *ctx, const void *v_key, size_t key_length) {
...
SECTION_CODE void hmac_sha256_update(HMAC_CTX *ctx, const void *message,
...
SECTION_CODE void hmac_sha256_final(HMAC_CTX *ctx, unsigned char *digest,
...
SECTION_CODE void crypto_hmac_sha256(const void *key, size_t key_length, const void *message,
